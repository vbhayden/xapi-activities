...
export default {
  ...
  mongoModelsRepo: {
    url: defaultTo<string>(process.env.MONGO_URL, 'mongodb://localhost:27017/xapiactivities'),
  },
  repoFactory: {
  ...
  s3StorageRepo: {
    ...
    bucketName: defaultTo<string>(process.env.FS_S3_BUCKET, 'xapi-activities'),
  ...
  winston: {
    cloudWatch: {
      ...
      logGroupName: defaultTo<string>(process.env.WINSTON_CLOUDWATCH_LOG_GROUP_NAME, 'xapi-activities'),
