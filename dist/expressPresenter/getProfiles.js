...
exports.default = function (config) {
    return catchErrors_1.default(config, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        var client, activityId, since, profileId;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, getProfilesFromService_1.default({ config: config, res: res, activityId: activityId, client: client, since: since })];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
                case 3:
